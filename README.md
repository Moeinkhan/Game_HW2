...
Key Features:
- Player controls Batman in a third-person perspective
...
- **Batmobile system**:
  - Drivable vehicle with basic movement controls
  - Camera smoothly switches between Batman and Batmobile 
- **Audio system**:
  - Continuous background music
  - Alert/State-based audio overlay 
